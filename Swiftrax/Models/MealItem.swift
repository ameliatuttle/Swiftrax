...
struct MealItem: Identifiable, Codable {
    ...
    // Calculate the scaled nutrition values based on quantity
   ...
   func scaledNutrition() -> NutritionInfo {
       ...
       // Break up the complex calculations with correct property names
       ...
       return NutritionInfo(
           ...
           carbohydrates: scaledCarbohydrates,  // Note: "carbohydrates", not "carbs"
           fat: scaledFat,
           fiber: scaledFiber,
           sugar: scaledSugar,
           sodium: scaledSodium,
